    ...
    <div class="container-fluid py-5">
        <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner border">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="img/iphone15-pro-max-1tb-titan-den.webp" alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="img/iphone15-pro-max-titan-xanh.webp" alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="img/iphone15-pro-max-1tb-titan-den.webp" alt="Image">
                        </div>
            ...
            <div class="col-lg-7 pb-5">
                ...
                <p class="mb-4">Mới, đầy đủ phụ kiện từ nhà sản xuất
                    1 ĐỔI 1 trong 30 ngày nếu có lỗi phần cứng nhà sản xuất. Bảo hành 12 tháng tại trung tâm bảo hành
                    chính hãng Apple: CareS(xem chi tiết)
                    Giá sản phẩm đã bao gồm VAT.</p>
                <!-- <div class="d-flex mb-3">
            ...
            <div class="col">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="tab-pane-1">
                        ...
                        <p>Thiết kế khung viền từ titan chuẩn hàng không vũ trụ - Cực nhẹ, bền cùng viền cạnh mỏng cầm
                            nắm thoải mái
                            Hiệu năng Pro chiến game thả ga - Chip A17 Pro mang lại hiệu năng đồ họa vô cùng sống động
                            và chân thực
                            Thoả sức sáng tạo và quay phim chuyên nghiệp - Cụm 3 camera sau đến 48MP và nhiều chế độ
                            tiên tiến
                            Nút tác vụ mới giúp nhanh chóng kích hoạt tính năng yêu thích của bạn.</p>
                    </div>
                ...
                <div class="owl-carousel related-carousel">
                    <div class="card product-item border-0">
                        <div
                            ...
                            <img class="img-fluid w-100" src="img/ip11 trang.jpg" alt="">
                        </div>
                        <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                            <h6 class="text-truncate mb-3">iPhone 14 128GB</h6>
                    ...
                    <div class="card product-item border-0">
                        <div
                            class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                            <img class="img-fluid w-100" src="img/ip15.jpg" alt="">
                        </div>
                        <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                            <h6 class="text-truncate mb-3">iPhone 15 Pro Max 256GB</h6>
                            <div class="d-flex justify-content-center">
                                <h6>$123.00</h6>
                                <h6 class="text-muted ml-2"><del>$123.00</del></h6>
                            </div>
                    ...
                    <div class="card product-item border-0">
                        ...
                        <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                            <h6 class="text-truncate mb-3">iPhone 13 Pro Max 128GB</h6>
                            <div class="d-flex justify-content-center">
                                <h6>$123.00</h6>
                                <h6 class="text-muted ml-2"><del>$123.00</del></h6>
                            </div>
                    ...
                    <div class="card product-item border-0">
                        ...
                        <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                            <h6 class="text-truncate mb-3">iPhone 12 64GB | Chính hãng VN/A</h6>
                            <div class="d-flex justify-content-center">
                                <h6>$123.00</h6>
                                <h6 class="text-muted ml-2"><del>$123.00</del></h6>
                            </div>
